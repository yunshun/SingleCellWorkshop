...
```
```{r SigScoreViolinPlot2, fig.cap="Violin plots of signature scores.", fig.height=8, fig.width=11}
...
```{r plotDisp, fig.cap="BCV and quasi-likelihood dispersion plots.", fig.height=5.5, fig.width=11}
par(mfrow=c(1,2))
plotBCV(y)
plotQLDisp(fit)
```
