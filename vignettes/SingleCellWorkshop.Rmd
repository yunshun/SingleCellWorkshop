...
In this workshop, we will be using five samples from this published study [@pal2021scrnaseqatlas].
These five samples correspond to five individual patients with the following Ids: N1469, N0280, N1105, N0230 and N0123.
...
dimUsed <- 30
N1469 <- RunUMAP(N1469, dims=1:dimUsed, seed.use=2020, verbose=FALSE)
N1469 <- RunTSNE(N1469, dims=1:dimUsed, seed.use=2020)
...
NormEpi <- RunUMAP(NormEpi, dims=1:dimUsed, seed.use=2020)
